package kr.co.dwebss.child.core;

/**
 * 프로젝트 상수
 */
public final class ProjectConstant {
    public static final String BASE_PACKAGE = "kr.co.dwebss.child"; //코드 이름 기본 패키지를 생성 할 경우, 그의 회사의 프로젝트 수정 (주에 따라 : 수동으로 기본 패키지 구성을 변경 한 후 프로젝트 src 디렉토리 경로를 수정해야의 그것은 동일하게 유지됩니다. 그렇지 않으면 클래스가 발견되지 않습니다)
