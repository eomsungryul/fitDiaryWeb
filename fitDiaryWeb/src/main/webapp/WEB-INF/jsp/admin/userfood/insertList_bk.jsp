          ...
          <div class="row mt-3">
			...
			<c:if test="${fn:length(resultList)!=0}">
				<c:forEach var="result" items="${ resultList }" varStatus="status">
          		<form:form modelAttribute="codeVO" id="registFrm_${status.count}" name="registFrm_${status.count}"  data-toggle="validator">
				  <div class="row border-bottom mb-3">
		            <div class="col-md-12 mb-3">
					  ...
					  <div id="foodDetailList_${status.count}" class="col-md-12 mb-3">
						  <div class="row">
					  ...
					  <div id="foodButtonList_${status.count}" class="col-md-12 mb-3">
						  <div class="row float-right">
							  <div>
						        	<button type="submit" class="btn btn-primary" onclick="fnAdd(this); return false;">음식추가</button>
			...
			<c:if test="${fn:length(resultList)==0}" >
				<tr>
				  <td colspan="5" class="text-center"> 음식 사진의 데이터를 모두 입력 하였습니다. </td>
				</tr>
			</c:if>
