...
<%--                 <a class="nav-link <c:if test="${ fn:indexOf(param.path,'/userfood') != -1}">active</c:if>" href="<%=contextPath %>/admin/userfood/list"> --%>
                <a class="nav-link <c:if test="${ fn:indexOf(param.path,'/userfood') != -1}">active</c:if>" href="<%=contextPath %>/admin/userfood/insertList">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline></svg>
                  	사용자 음식 칼로리 관리
                </a>
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link <c:if test="${ fn:indexOf(param.path,'/userHealth') != -1}">active</c:if>" href="<%=contextPath %>/admin/userHealth/insertList">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline></svg>
                  	사용자 인바디 입력
                </a>
              </li>
